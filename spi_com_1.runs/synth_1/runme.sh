...
HD_PWD='C:/Users/gdela/spi_com_1/spi_com_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_com_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_com_wrapper.tcl
