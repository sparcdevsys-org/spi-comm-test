...
HD_PWD='C:/Users/gdela/spi_com_1/spi_com_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_com_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source spi_com_wrapper.tcl -notrace
