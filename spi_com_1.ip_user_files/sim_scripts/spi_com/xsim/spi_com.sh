...
#
# Script generated by Vivado on Sun Apr 19 02:20:38 -0400 2026
...
#
# Usage        : spi_com.sh
#                spi_com.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                spi_com.sh [-rerun]
#                spi_com.sh [-reset_run]
#                spi_com.sh [-clean]
#                spi_com.sh [-reset_log]
#                spi_com.sh [-help]
#
...
# script info
echo -e "spi_com.sh - Script generated by export_simulation (Vivado v2025.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./spi_com.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L processing_system7_vip_v1_0_24 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot spi_com xil_defaultlib.spi_com xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim spi_com -key {Behavioral:sim_1:Functional:spi_com} -tclbatch cmd.tcl -protoinst "protoinst_files/spi_com.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb spi_com.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./spi_com.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: spi_com.sh [-help]\n\
Usage: spi_com.sh [-step]\n\
Usage: spi_com.sh [-lib_map_path]\n\
Usage: spi_com.sh [-rerun]\n\
Usage: spi_com.sh [-reset_run]\n\
Usage: spi_com.sh [-clean]\n\
Usage: spi_com.sh [-reset_log]\n\
Usage: spi_com.sh [-keep_index]\n\
Usage: spi_com.sh [-noclean_files]\n\n\
